...
public class PlayerInformationRepository {
    ...
    @Transactional
    public void persistPlayerInformation(PlayerInformation playerInformation) {
    ...
    @Transactional
    public void update(PlayerInformation playerInformation) {
        em.merge(playerInformation);
    }
}
